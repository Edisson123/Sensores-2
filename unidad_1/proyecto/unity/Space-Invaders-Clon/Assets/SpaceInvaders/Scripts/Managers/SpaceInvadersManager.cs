...
public class SpaceInvadersManager : MonoBehaviour
{
    ...
    public GameObject panelPuertos;
    public GameObject serialController;
    public GameObject serialControllerBinario;
    ...
    public void ResetUIPanels()
    {
        ...
        panelPuertos.SetActive(false);
        serialController.SetActive(true);
        serialControllerBinario.SetActive(true);
    }

    private void inicialPanels()
    {
        gameContainer.SetActive(false);
        inGameUI.SetActive(false);
        mainMenuPanel.SetActive(false);
        pauseMenuPanel.SetActive(false);
        panelPuertos.SetActive(true);
        serialController.SetActive(false);
        serialControllerBinario.SetActive(false);
    }
